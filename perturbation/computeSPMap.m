function [spMap,XBinned,yBinned,features,probability_sampled] = computeSPMap(feature,coordinates)
...
%   spatially ranked perturbation indices (the SP map). The x and y axes 
...
%   See also computeCorrelation and virtualRemovalSP.
    ...
    X = [features(1,1) features(1,2) features(2,2)];
