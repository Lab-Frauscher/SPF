...
% automated pipeline if you wish to play with some parameters, have fun!
...
% across clusters, and when comparing surgical outcome within the good 
% sampling cluster (Figure 8). The SOZ volume was compared after correcting 
